...
const AceternityIcon = ({ order }: { order: string }) => {
  return (
    <div className="">
      <button className="relative w-full min-w-52 inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none md:w-56 md:mt-10">
        <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
        <span
          className={`inline-flex h-full w-full cursor-pointer items-center justify-center overflow-hidden rounded-full bg-slate-950 px-3 text-xl font-medium text-white backdrop-blur-3xl gap-2`}
        >
          {order}
        </span>
      </button>
